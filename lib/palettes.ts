...
export const PALETTES: Palette[] = [
  ...
  },
  {
    ...
    colors: [
      { name: "Olive", hex: "#79BF3E", role: "Primary" },
      { name: "Sky", hex: "#3BB8E6", role: "Accent" },
      { name: "Cream", hex: "#FFF7C9", role: "Background" },
      { name: "Charcoal", hex: "#252520", role: "Text" },
    ],
    combosImages: ["/palette-b-logos.png"],
  },
  {
    id: "palette-c",
    title: "Option C",
